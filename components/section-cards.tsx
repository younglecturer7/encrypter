...
export function SectionCards() {
  return (
    <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 text-center gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4">
          ...
          <CardFooter className="flex-col justify-between space-y-5 text-sm">
            ...
            <CardAction className="flex-1 justify-center text-center gap-1.5">
              <Button variant="outline" size="sm" asChild>
                <Link href="encrypter-simulator">
                  Open Encryption Simulator
                </Link>
              </Button>
            </CardAction>
          </CardFooter>
        ...
        <Card className="w-full min-w-xs">
          ...
          <CardFooter className="flex-col justify-between space-y-5 text-sm">
            ...
            <CardAction className="flex-1 justify-center text-center gap-1.5">
              <Button variant="outline" size="sm" asChild>
                <Link href="decrypter-simulator">
                  Open Decryption Simulator
                </Link>
              </Button>
            </CardAction>
          </CardFooter>
